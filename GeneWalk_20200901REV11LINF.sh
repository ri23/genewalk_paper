#!/bin/bash
#Robert Ietswaart 
#sbatch job to run GeneWalk for REV11 for GENBIO REVISIONS
#source: 20200213REV0 

revv=REV11LINF
date=20200901a${revv} #also ran 20200901${revv} : did not finish, see N6p197
...
data_source=indra #"indra pc" #
Treatment=JQ1 #"QKI JQ1" 
nthread=4 #for stats 1 #all others: 4 
SEEDS=1234 #"42 1234" 
...
do
    ...
    do
        ...
        do
            ...
            stage=statistics #null_distribution #all # #all 
        
            jobname=GeneWalk_${date}_${tr}_${ds}_seed${seed}_stage${stage}
            sbatch -p short -n ${nthread} --mem=2G -t 0-00:10:00 --job-name=${jobname} \
