...
from genewalk.deepwalk_REV9GDGO import run_walks #REV9GDGO
...
def main():
    ...
    if args.stage in ('all', 'node_vectors'):
        ...
        for i in range(args.nreps_graph):
            ...
            DW = run_walks(MG.graph, workers=args.nproc, real_graph=True)#REV9GDGO
    ...
    if args.stage in ('all', 'null_distribution'):
        ...
        for i in range(args.nreps_null):
            ...
            DW = run_walks(RG, workers=args.nproc, real_graph=False)#REV9GDGO
