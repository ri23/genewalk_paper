...
class PcNxMgAssembler(NxMgAssembler):
    ...
    def add_pc_edges(self):
        ...
        pc.add_nodes_from(hgnc_symbols)#REV2DEGS: Add all mapped DEGS = hgnc_symbols to multigraph
        ...
        #self.graph.remove_nodes_from(nx.isolates(pc_sub))#REV2DEGS: comment out this line
        ...
        for i, st in enumerate(self.stmts):
            ...
            for a, b in itertools.combinations(agents, 2):
                ...
                self.graph.add_edge(a_node, b_node, key=edge_key,
                                    label=edge_type)
        hgnc_symbols = [g['HGNC_SYMBOL'] for g in self.genes]#REV2DEGS: Add all mapped DEGS = hgnc_symbols to multigraph
        self.graph.add_nodes_from(hgnc_symbols)#REV2DEGS: Add all mapped DEGS = hgnc_symbols to multigraph
