...
from genewalk.nx_mg_assembler_REV0 import load_network
from genewalk.gene_lists_REV0 import read_gene_list
...
from genewalk import logger as root_logger, default_logger_format, \
    default_date_format
from genewalk.resources_REV0 import ResourceManager
...
def main():
    ...
    if args.stage in ('all', 'node_vectors'):
        ...
        for i in range(args.nreps_graph):
            ...
            DW = run_walks(MG.graph, workers=args.nproc, niter=1, walk_length=1000) #REV11: 20200901a:niter=1 20200901:niter_default, did not finish
    ...
    if args.stage in ('all', 'null_distribution'):
        ...
        for i in range(args.nreps_null):
            ...
            DW = run_walks(RG, workers=args.nproc, niter=1, walk_length=1000) #REV11: 20200901a:niter=1 20200901:niter_default
