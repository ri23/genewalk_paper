...
#         pc = nx.from_pandas_edgelist(gwn_df, source='source', target='target',#REV1:NOGG comment out this line
...
#         # subset over genes in the input gene list
        ...
        #REV1:NOGG BEGIN begin chunk
        pc_sub = nx.MultiGraph()
        pc_sub.add_nodes_from(hgnc_symbols)
        #REV1:NOGG end chunk
#         pc_sub = pc.subgraph(hgnc_symbols)#REV1:NOGG: comment out this line
...
#         self.graph.remove_nodes_from(nx.isolates(pc_sub))#REV1:NOGG: comment out this line
