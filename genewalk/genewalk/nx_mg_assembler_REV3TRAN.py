            ...
            for go_id in go_ids:
                if go_id in self.go_dag:
                    ...
                    self.graph.add_edge(gene['HGNC_SYMBOL'], go_term.id,
                                        label='GO:annotation')
                    #REV3TRAN: beginadded Transitivity property
                    for parent_term in go_term.parents:
                        ...
                        self.graph.add_node(go_term.id,
                                            ...
                                            GO=go_term.id,
                                            domain=go_term.namespace)
                        self.graph.add_edge(gene['HGNC_SYMBOL'], parent_term.id,
                                            label='GO:transitivity')
                    #REV3TRAN: end added Transitivity property
